...
var lotsSlider = new Swiper('.lots-slider', {
	speed: 500,
	slidesPerView: 3,
    navigation: {
		prevEl: '.lots-slider-arrow_left',
		nextEl: '.lots-slider-arrow_right',
	  },
	//loop: false,
	loop: true, // for test
	grabCursor: true,
...
var blockquotesSlider = new Swiper('.blockquotes-slider', {
	speed: 1000,
	navigation: {
		nextEl: '.blockquotes-slider-control-panel__btn-refresh',
	  },
	loop: true,
	grabCursor: true,
	effect: 'fade',
	...
	on: {
		sliderMove: function () {
			if (!$('.blockquotes-slider-control-panel__btn-refresh span').hasClass('rotating')) {
				$('.blockquotes-slider-control-panel__btn-refresh span').addClass('rotating');
			}
		},
		slideChangeTransitionStart: function () {
			if (!$('.blockquotes-slider-control-panel__btn-refresh span').hasClass('rotating')) {
		...
		slideChangeTransitionEnd: function () {
			$('.blockquotes-slider-control-panel__btn-refresh span').removeClass('rotating');
		},
		touchStart: function () {
			$('.blockquotes-slider-control-panel__btn-refresh span').addClass('rotating');
		},
		touchEnd: function () {
			setTimeout( function() { $('.blockquotes-slider-control-panel__btn-refresh span').removeClass('rotating') }, 1000);
		},
	},
});
/*
